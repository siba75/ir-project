...
def evaluate_mode(mode):
    queries, qrels = load_cranfield_eval_data()
...
def main():
    ...
    output_path = BASE_DIR / "reports" / "cranfield_evaluation_results.json"
